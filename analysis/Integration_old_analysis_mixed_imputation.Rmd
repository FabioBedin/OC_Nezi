---
title: "Single patient comparison T1 vs T2"
...
```{r AHDC1_plot, message=FALSE, warning=FALSE, fig.height = 7, fig.width = 10}
...
ggplot(all_int, mapping = aes(x = sample, y = intensity, group = rowname)) + 
  ...
  labs(title = "AHDC1", x = "Samples", y = "log2 Intensity") + 
...
```{r save_excel}
saveWorkbook(excel, here::here("output/results_T2_vs_T1_patients.xlsx"), overwrite = T)
```
