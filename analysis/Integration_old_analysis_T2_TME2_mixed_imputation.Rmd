---
title: "Single patient comparison T2 vs TME2"
...
unique_vec <- c("MRPS36", "SNRPC", "BUD31", "CDKN2A", "CTSL", "DCP1B", "DENND4C", "ESRP1", "EWSR1", "NCKAP1L", "NIPSNAP1", "RDH14", "SCRN2", "SEL1L", "SRSF9", "SYNGR2", "TBCD", "TFCP2", "TMLHE", "TSTD1")
...
unique_vec <- c("MRPS36", "SNRPC", "APOBEC3C", "ECM1", "GPNMB", "PODN", "SGCD", "SRPX", "TMEM119")
...
unique_vec <- c("AHDC1", "UTS2", "SACS", "BCKDHB", "BIRC6", "CBX5", "DCP1B", "LTBP4", "METAP1", "NCOR2", "NDUFB10", "NXF1", "POLR2E", "RAB43", "SETD3", "TGM1", "TOMM22", "VWA5A")
...
unique_vec <- c("AHDC1", "UTS2", "SACS", "APOBEC3C", "SERPINA6", "STX1A", "UPF2")
...
```{r IGKV3D-11_plot, message=FALSE, warning=FALSE, fig.height = 7, fig.width = 10}
...
ggplot(all_int, mapping = aes(x = sample, y = intensity, group = rowname)) + 
  ...
  labs(title = "IGKV3D-11", x = "Samples", y = "log2 Intensity") + 
...
```{r save_excel}
saveWorkbook(excel, here::here("output/results_T2_vs_TME2_patients.xlsx"), overwrite = T)
```
